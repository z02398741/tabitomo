...
const D: Record<string, Entry> = {
  ...
  destCandidatesTitle: {
    ja: '📍 目的地の候補です（タップ、または「スキー」「登山」などジャンルで絞り込み）',
    zh: '📍 目的地候選（點選，或輸入「滑雪」「爬山」等類型來篩選）',
  },
  destRegen: { ja: '🔄 別の候補', zh: '🔄 換一批' },
  genFailed: {
    ja: '⚠️ 生成に失敗しました: {err}\nもう一度「提案して」で試してください。',
    zh: '⚠️ 生成失敗：{err}\n請再輸入「提案」重試一次。',
  },
  ...
  genOrigin: { ja: '🚩 出発地：{v}', zh: '🚩 出發地：{v}' },
  genTransport: { ja: '🚗 移動手段：{v}', zh: '🚗 交通方式：{v}' },
